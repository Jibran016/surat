...
@section('title', 'Edit Akun - SURATIN')
...
<div class="mx-auto max-w-2xl rounded-3xl border border-pink-100 bg-white/90 p-8 shadow-[0_30px_60px_-40px_rgba(236,72,153,0.45)]">
    <div class="mb-6">
        <h1 class="text-2xl font-semibold text-slate-900">Edit Akun</h1>
        <p class="mt-2 text-sm text-slate-500">Perbarui data akun yang dipilih.</p>
    </div>

    <form method="POST" action="{{ route('users.update', $user) }}" class="grid gap-5 sm:grid-cols-2">
        @csrf
        @method('PUT')
